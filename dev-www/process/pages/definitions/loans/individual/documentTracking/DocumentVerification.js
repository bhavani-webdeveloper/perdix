irf.pageCollection.factory(irf.page("loans.individual.documents.DocumentVerification"), ["$log", "$state", "Enrollment", "lead", "EnrollmentHelper", "SessionStore", "formHelper", "$q", "irfProgressMessage",
