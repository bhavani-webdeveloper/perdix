irf.pageCollection.factory(irf.page("DocumentTracking.DocumentVerification"), ["$log", "$state", "Enrollment", "lead", "EnrollmentHelper", "SessionStore", "formHelper", "$q", "irfProgressMessage",
