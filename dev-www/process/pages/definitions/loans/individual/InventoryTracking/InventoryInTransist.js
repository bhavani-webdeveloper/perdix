irf.pageCollection.factory(irf.page("loans.individual.InventoryTracking.InventoryInTransist"), ["$log", "$state","$stateParams", "Inventory", "InventoryHelper", "SessionStore", "formHelper", "$q", "irfProgressMessage",
