irf.pageCollection.factory(irf.page("loans.individual.booking.PsychometricPendingQueue"), 
		...
		return {
			...
			definition: {
				...
				listOptions: {
					...
					getActions: function() {
						return [{
							name: "PSYCHOMETRIC_PENDING",
							desc: "",
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('loan.PsychometricPending', {
									_request: item
								});
								$state.go("Page.Engine", {
									pageName: "loans.individual.booking.PsychometricPending",
									pageId: item.id
								});
							},
