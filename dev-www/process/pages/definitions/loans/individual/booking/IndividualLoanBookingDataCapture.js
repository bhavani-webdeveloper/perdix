irf.pageCollection.factory(irf.page("loans.individual.booking.DataCapture"),
    ["$log","SessionStore","$state", "$stateParams", "SchemaResource",
        function($log, Enrollment, SessionStore,$state,$stateParams, SchemaResource){

        var branch = SessionStore.getBranch();

        return {
            "id": "IndividualLoanBookingDataCapture",
            "type": "schema-form",
            "name": "IndividualLoanBookingDataCapturePage",
