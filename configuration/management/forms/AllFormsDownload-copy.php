...
function create_zip($files = array(),$file_path='', $destination = '',$overwrite = false) {
	...
	$jsp_form_link = "http://54.83.139.254:8080/forms/";
	$folder_path = "/opt/mount_point/nginx/management-migration/forms/temp-forms/temp/";
	...
	LEFT JOIN (SELECT account_number as `AccountNumber`, `product_code` 
