    irf.models.factory('Reports', function($resource, $httpParamSerializer, BASE_URL,searchResource, formHelper, SessionStore, Enrollment, IndividualLoan) {
	...
	reportParameterList: {
            method: 'GET',
            url: endpoint + '/reportmaster/report_parameter_mapping.php',
            isArray: true
        },
        reportParametername: {
            method: 'GET',
            url: endpoint + '/reportmaster/report_parameter_master_names.php',
          
        },
        reportList: {
            method: 'GET',
            url: endpoint + '/reportmaster/report_master_names.php',
            isArray: true
        }, 
        reportUpdate: {
            method: 'POST',
	...
	getConfigurationJson:{
        ...
        updateReportMapping:{
            method:'POST',
            url: endpoint +'/reportmaster/report_parameter_mapping_data.php'
        },
    });
    return res;
});