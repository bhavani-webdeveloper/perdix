irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.disbursement.ReadyForDisbursementQueue"),
                            ...
                            return [
                                {
                                    ...
                                    fn: function(item, index){
                                        entityManager.setModel('shramsarathi.dashboard.loans.individual.disbursement.Disbursement', {_disbursement:item});
                                        $state.go("Page.Engine",{
                                            pageName:"shramsarathi.dashboard.loans.individual.disbursement.Disbursement",
