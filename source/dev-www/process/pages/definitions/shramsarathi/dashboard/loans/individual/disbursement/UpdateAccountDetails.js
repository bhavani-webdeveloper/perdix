irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.disbursement.UpdateAccountDetails"),
    ...
    return {
        ...
        initialize: function (model, form, formCtrl) {
            ...
            if (!model._rejectedDisbursementQueue)
            {
                ...
                $state.go('Page.Engine', {pageName: 'shramsarathi.dashboard.loans.individual.disbursement.RejectedDisbursementQueue', pageId: null});
                return;
            }
