irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.collections.CreditValidationQueue"),
                    ...
                    return [
                        {
                            ...
                            fn: function(item, index){
                                entityManager.setModel('shramsarathi.dashboard.loans.individual.collections.CreditValidation', {_credit:item});
                                $state.go('Page.Engine', {pageName: 'shramsarathi.dashboard.loans.individual.collections.CreditValidation', pageId: item.id});
                            },
