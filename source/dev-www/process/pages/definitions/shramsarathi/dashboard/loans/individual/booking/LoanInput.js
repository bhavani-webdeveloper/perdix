irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.LoanInput"),
        ...
        return {
            ...
            initialize: function (model, form, formCtrl) {
                ...
                var init = function(model, form, formCtrl) {
                    ...
                    PagesDefinition.getPageConfig("Page/Engine/shramsarathi.dashboard.loans.individual.booking.LoanInput").then(function(data){
                        $log.info(data);
