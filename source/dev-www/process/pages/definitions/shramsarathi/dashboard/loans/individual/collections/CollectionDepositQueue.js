define({
    pageUID: "shramsarathi.dashboard.loans.individual.collections.CollectionDepositQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, model) {
                                irfNavigator.go({
                                    'state': 'Page.Engine',
                                    'pageName': 'shramsarathi.dashboard.loans.individual.collections.DepositStageDetail',
                                    'pageData': item
                                });
                            },
