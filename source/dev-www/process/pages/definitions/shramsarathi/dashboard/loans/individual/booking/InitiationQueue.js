irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.InitiationQueue"),
				...
				getActions: function(){
					return [{
						...
						fn: function(item, index){
							irfNavigator.go({
								'state': 'Page.Engine',
								'pageName': 'shramsarathi.dashboard.loans.individual.booking.LoanInput',
								'pageId': item.loanId,
								'pageData': item
							});								
						},
						...
						fn: function(item, index){
							irfNavigator.go({
                                'state': 'Page.Engine',
                                'pageName': 'shramsarathi.dashboard.loans.individual.booking.SimpleLoanInput',
                                'pageId': item.loanId,
                                'pageData': item
                            });								
						},
