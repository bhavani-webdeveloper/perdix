irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.PendingQueue"),
                    ...
                    return [
                        {
                            ...
                            fn: function(item, index){
                                ...
                                $state.go('Page.Engine', {pageName: 'shramsarathi.dashboard.loans.individual.booking.LoanBooking', pageId: item.loanId});
                            },
