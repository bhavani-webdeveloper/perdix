define(["perdix/domain/model/loan/LoanProcess",
    ...
    "perdix/domain/model/loan/LoanCustomerRelation",
        ...
        return {
            pageUID: "shramsarathi.dashboard.loans.individual.screening.ApplicationReview",
            pageType: "Bundle",
                ...
                return {
                    ...
                    "bundleDefinitionPromise": function() {
                        return $q.resolve([
                            ...
                            {
                                pageName: 'shramsarathi.dashboard.loans.individual.screening.detail.PortfolioAnalysis',
