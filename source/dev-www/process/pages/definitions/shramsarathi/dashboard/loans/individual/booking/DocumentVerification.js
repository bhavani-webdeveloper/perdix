irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.DocumentVerification"), ["$log", "SessionStore", "$state","irfNavigator", "$stateParams", "PageHelper", "IndividualLoan", "LoanBookingCommons", "Utils", "Files", "Queries", "formHelper", "$q", "$filter",
                        ...
                        IndividualLoan.update(reqData)
                            ...
                            .then(function (res) {
                                ...
                                $state.go('Page.Engine', {
                                    pageName: 'shramsarathi.dashboard.loans.individual.booking.PendingVerificationQueue'
                                });
                            }, function (httpRes) {
                    ...
                    Utils.confirm("Save the data before proceed").then(function() {
                        ...
                        if(model.loanView) {
                            ...
                            irfNavigator.go({
                                ...
                                state: "Page.Engine",
                                pageName: "shramsarathi.dashboard.loans.individual.booking.DocumentVerification",
                                pageId: model.loanAccount.id
                            });
                        }
                    });
