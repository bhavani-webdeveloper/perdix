irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.DocumentUpload"), ["$log", "Enrollment", "SessionStore", "$state", '$stateParams', 'PageHelper', 'IndividualLoan', 'Queries', 'Utils', 'formHelper', "LoanProcess", "CustomerBankBranch", "SchemaResource", "LoanAccount", "Misc","irfNavigator", "PagesDefinition","$q",
            ...
            initialize: function(model, form, formCtrl) {
                ...
                if (!model._queue) {
                    ...
                    $state.go('Page.Engine', {
                        pageName: 'shramsarathi.dashboard.loans.individual.booking.DocumentUploadQueue',
                        pageId: null
                    });
                    return;
                }
