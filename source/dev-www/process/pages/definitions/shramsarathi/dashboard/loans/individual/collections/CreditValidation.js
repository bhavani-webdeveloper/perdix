irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.collections.CreditValidation"), ["$log", "$q", 'Pages_ManagementHelper', 'LoanCollection', 'LoanAccount', 'PageHelper', 'formHelper', 'irfProgressMessage', "Locking",
            ...
            initialize: function (model, form, formCtrl) {
                ...
                if (!model._credit) {
                    ...
                    $state.go('Page.Engine', {
                        pageName: 'shramsarathi.dashboard.loans.individual.collections.CreditValidationQueue',
                        pageId: null
                    });
                    return;
                }
