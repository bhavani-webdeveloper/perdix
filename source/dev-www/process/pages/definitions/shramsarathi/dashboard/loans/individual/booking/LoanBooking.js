irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.LoanBooking"),
    ...
    function ($log, irfNavigator, IndividualLoan, SessionStore, $state, $stateParams, SchemaResource, PageHelper,PagesDefinition, Enrollment, Utils,Queries, $q, formHelper) {
        ...
        return {
            ...
            initialize: function (model, form, formCtrl) {
                ...
                PagesDefinition.getPageConfig("Page/Engine/shramsarathi.dashboard.loans.individual.booking.LoanBooking").then(function(data){
                    ...
                    .then(
                        function (res) {
                            ...
                            if (res.currentStage!= 'LoanBooking'){
                                ...
                                $state.go('Page.Engine', {pageName: 'shramsarathi.dashboard.loans.individual.booking.PendingQueue'});
                                return;
                            }
            ...
            actions: {
                ...
                reenter: function (model, formCtrl, form, $event) {
                    $state.go("Page.Engine", {
                        pageName: 'shramsarathi.dashboard.loans.individual.booking.PendingQueue',
                        pageId: null
                    });
                }
            }
