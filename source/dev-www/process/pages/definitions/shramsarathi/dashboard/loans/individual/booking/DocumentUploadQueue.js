irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.booking.DocumentUploadQueue"),
                    ...
                    return [
                        {
                            ...
                            fn: function(item, index){
                                if (siteCode == 'pahal') {
                                    ...
                                    irfNavigator.go({
                                        state: 'Page.Engine',
                                        pageName: 'shramsarathi.dashboard.loans.individual.booking.DocumentUpload',
                                        pageData: item,
                                        pageId: item.loanId
                                    }, {
                                        state: 'Page.Engine',
