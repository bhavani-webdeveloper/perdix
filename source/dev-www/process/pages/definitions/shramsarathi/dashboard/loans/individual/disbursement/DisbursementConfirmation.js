irf.pageCollection.factory(irf.page("shramsarathi.dashboard.loans.individual.disbursement.DisbursementConfirmation"),
        ...
        function ($log, $q, Enrollment, GroupProcess, LoanAccount, SessionStore, $state, $stateParams, PageHelper, IndividualLoan, SchemaResource, Utils, Locking) {
            ...
            var backToQueue = function () {
                $state.go("Page.Engine", {
                    pageName: "shramsarathi.dashboard.loans.individual.disbursement.DisbursementConfirmationQueue",
                    pageId: null
                });
            };
