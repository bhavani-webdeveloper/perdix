define(['perdix/infra/api/AngularResourceService'], function (AngularResourceService) {
    return {
        pageUID: "customer.banking.CashManagement",
        pageType: "Engine",
                                            ...
                                            onChange:function(value, form, model){
                                                if(value != "" ){
                                                    cashBal(model.cashManagement.eodCashBalanceDto.transactionDate).then(function(resp){
                                                        ...
                                                        var actual = (model.cashManagement.eodCashBalanceDto.jewelPouchCountInBranch )+ (model.cashManagement.eodCashBalanceDto.jewelPouchCountInHub) + (model.cashManagement.eodCashBalanceDto.jewelPouchCountInTransit);
                                                    },function(err){
                                                        console.log(err);
                                                        model.cashManagement = {};
                                                    })
