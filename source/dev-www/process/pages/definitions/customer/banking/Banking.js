irf.pageCollection.factory(irf.page("customer.banking.Banking"),
...
function($log, formHelper,filterFilter, Enrollment,Queries,$q,$state, SessionStore, Utils, PagesDefinition, irfNavigator){
	...
	return {
		...
		initialize: function (model, form, formCtrl) {
			...
			PagesDefinition.getPageConfig('Page/Engine/customer.banking.Banking').then(function(data){
				...
				getActions: function(){
					return [
						...
						},
						{
							...
							fn: function(item, model){
								$state.go("Page.Engine",{
									pageName:"customer.banking.SBTransaction",
									pageId:item.id,
