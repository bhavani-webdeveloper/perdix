irf.pageCollection.factory(irf.page("audit.PublishedAuditsViewQueue"),
["$log", "formHelper", "Queries", "User", "$stateParams", "irfNavigator", "Audit", "$state", "$q", "SessionStore", "PageHelper",
function($log, formHelper,Queries, User, $stateParams, irfNavigator, Audit, $state, $q, SessionStore, PageHelper) {
    var returnObj = {
        "type": "search-list",
