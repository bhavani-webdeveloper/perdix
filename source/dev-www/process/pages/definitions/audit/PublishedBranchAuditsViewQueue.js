irf.pageCollection.factory(irf.page("audit.PublishedBranchAuditsViewQueue"), ["$log", "Utils", "formHelper", "Queries", "User", "$stateParams", "irfNavigator", "Audit", "$state", "$q", "SessionStore", "PageHelper",
