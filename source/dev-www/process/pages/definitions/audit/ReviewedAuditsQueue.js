irf.pageCollection.factory(irf.page("audit.ReviewedAuditsQueue"),
["$log","Queries","User", "formHelper", "$stateParams", "irfNavigator", "Audit", "$state", "$q", "SessionStore", "Utils", "PageHelper",
