irf.pageCollection.factory(irf.page("audit.detail.processcompliance.SampleIssues"), ["$log", "$state", "SessionStore", "irfNavigator", "$stateParams", "$http", "Audit", "PageHelper", "$q", "elementsUtils", "formHelper", "User",
    function($log, $state, SessionStore, irfNavigator, $stateParams, $http, Audit, PageHelper, $q, elementsUtils, formHelper, User) {
        var master = null;
