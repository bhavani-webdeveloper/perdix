irf.pageCollection.factory(irf.page("audit.ReviewedAuditsViewQueue"), ["$log", "Queries", "User", "formHelper", "$stateParams", "irfNavigator", "Audit", "$state", "$q", "SessionStore", "PageHelper",
                        ...
                        return [{
                            ...
                            fn: function(item, index) {
                                if (item.audit_type = 1) {
                                    ...
                                    var backparam = {
                                        'state': 'Page.Engine',
                                        'pageName': 'audit.ReviewedAuditsViewQueue',
                                        'pageId': item.audit_id,
                                        'pageData': {
                                            "page": returnObj.definition.listOptions.tableConfig.page
                                        }
