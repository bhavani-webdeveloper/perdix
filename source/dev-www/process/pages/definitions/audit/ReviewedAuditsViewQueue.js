irf.pageCollection.factory(irf.page("audit.ReviewedAuditsViewQueue"),
["$log","Queries", "User", "formHelper", "$stateParams", "irfNavigator", "Audit", "$state", "$q", "SessionStore", "PageHelper",
