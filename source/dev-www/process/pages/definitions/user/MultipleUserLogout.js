irf.pageCollection.factory(irf.page('user.MultipleUserLogout'), ["$log", "User", "$q", "$timeout", "SessionStore", "$state", "entityManager", "formHelper", "$stateParams", "irfProgressMessage", "PageHelper", "irfStorageService", "$filter",
