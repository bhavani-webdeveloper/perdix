define({
    pageUID: "pahal.lead.ReadyForScreeningQueue",
    pageType: "Engine",
				...
				listOptions: {
					...
					getActions: function() {
						...
						},
						{
							...
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('pahal.lead.LeadGeneration', {
									_request: item
								});
						...
						},
						{
							...
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('pahal.lead.LeadReject', {
									_request: item
								});
								$state.go("Page.Engine", {
									pageName: "pahal.lead.LeadReject",
									pageId: item.id
								});
							},
							isApplicable: function(item, index) {
