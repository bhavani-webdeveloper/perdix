define({
     pageUID: "pahal.loans.individual.screening.CreditApproval1Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.CreditApproval1', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.CreditApproval1",
                                    pageId: item.loanId
                                });
                            },
