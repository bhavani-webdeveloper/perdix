define({
    pageUID: "pahal.loans.individual.screening.GoNoGoApproval2Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.GoNoGoApproval2', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.GoNoGoApproval2",
                                    pageId: item.loanId
                                });
                            },
