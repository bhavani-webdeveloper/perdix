define({
     pageUID: "pahal.loans.individual.screening.DeviationApprovalQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.DeviationApproval', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.DeviationApproval",
                                    pageId: item.loanId
                                });
                            },
