define({
    pageUID: "pahal.loans.individual.screening.FieldInvestigation1Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.FieldInvestigation1', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.FieldInvestigation1",
                                    pageId: item.loanId
                                });
                            },
