define(["perdix/domain/model/loan/LoanProcess",
    ...
    "perdix/domain/model/loan/LoanCustomerRelation",
        ...
        return {
            pageUID: "pahal.loans.individual.screening.GoNoGoApproval1",
            pageType: "Bundle",
                ...
                return {
                    ...
                    "bundleDefinitionPromise": function() {
                        return $q.resolve([
                            ...
                            {
                                pageName: 'pahal.loans.individual.screening.detail.Scoring',
                                title: 'Scoring',
                                pageClass: 'scoring',
                                minimum: 1,
                                maximum: 1,
                    ...
                    "pre_pages_initialize": function(bundleModel){
                        ...
                        bundleModel.currentStage = "GoNoGoApproval1";
                        var deferred = $q.defer();
                    ...
                    "post_pages_initialize": function(bundleModel){
                        ...
                        BundleManager.broadcastEvent('origination-stage', 'GoNoGoApproval1');
...
// irf.pageCollection.factory(irf.page('pahal.loans.individual.screening.ScreeningReview'),
...
//                     },
//                     {
//                         pageName: 'pahal.customer.IndividualEnrolment2',
//                         title: 'CO_APPLICANT',
//                         pageClass: 'co-applicant',
//                         minimum: 0,
//                         maximum: 3
