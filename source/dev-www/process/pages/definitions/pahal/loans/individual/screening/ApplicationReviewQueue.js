define({
	pageUID: "pahal.loans.individual.screening.ApplicationReviewQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('pahal.loans.individual.screening.ApplicationReview', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "pahal.loans.individual.screening.ApplicationReview",
									pageId: item.loanId
								});
							},
