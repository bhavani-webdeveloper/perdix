define({
    pageUID: "pahal.loans.individual.screening.CreditAppraisalQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.CreditAppraisal', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.CreditAppraisal",
                                    pageId: item.loanId
                                });
                            },
