define({
     pageUID: "pahal.loans.individual.screening.DeviationApproval1Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.DeviationApproval1', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.DeviationApproval1",
                                    pageId: item.loanId
                                });
                            },
...
// irf.pageCollection.factory(irf.page("pahal.loans.individual.screening.ScreeningReviewQueue"),
...
//                          icon: "fa fa-pencil-square-o",
//                          fn: function(item, index) {
//                              entityManager.setModel('pahal.loans.individual.screening.ScreeningReview', {
//                                  _request: item
//                              });
//                              $state.go("Page.Bundle", {
//                                  pageName: "pahal.loans.individual.screening.ScreeningReview",
//                                  pageId: item.loanId
//                              });
//                          },
//                          isApplicable: function(item, index) {
