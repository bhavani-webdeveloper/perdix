define({
    pageUID: "pahal.loans.individual.screening.FieldInvestigation2Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('pahal.loans.individual.screening.FieldInvestigation2', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "pahal.loans.individual.screening.FieldInvestigation2",
                                    pageId: item.loanId
                                });
                            },
