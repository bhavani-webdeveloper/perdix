define({
    pageUID: "kgfs.kgfsWorkflow.GpsFPUpdateQueue",
    pageType: "Engine",
    dependencies: ["$log","$stateParams", "formHelper","filterFilter", "Enrollment","Workflow","Queries","$q","$state", "SessionStore", "Utils", "PagesDefinition", "irfNavigator"],
    $pageFn: function ($log,$stateParams, formHelper,filterFilter, Enrollment,Workflow,Queries,$q,$state, SessionStore, Utils, PagesDefinition, irfNavigator) {
