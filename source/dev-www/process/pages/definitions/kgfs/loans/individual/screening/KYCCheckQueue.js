define({
	pageUID: "kgfs.loans.individual.screening.KYCCheckQueue",
   pageType: "Engine",
				...
				getActions: function () {
					return [{
						...
						fn: function (item, index) {
							entityManager.setModel('kgfs.loans.individual.screening.KYCCheck', {
								_request: item
							});
							irfNavigator.go({
								state: "Page.Bundle",
								pageName: "kgfs.loans.individual.screening.KYCCheck",
								pageId: item.loanId
							}, {
									state: 'Page.Engine',
									pageName: "kgfs.loans.individual.screening.KYCCheckQueue"
								});
						},
