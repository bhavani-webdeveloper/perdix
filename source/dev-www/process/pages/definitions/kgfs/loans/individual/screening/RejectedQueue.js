define({
	pageUID: "kgfs.loans.individual.screening.RejectedQueue",
   pageType: "Engine",
				...
				getActions: function () {
					return [{
						...
						fn: function (item, index) {
							entityManager.setModel('kgfs.loans.individual.screening.Rejected', {
								_request: item
							});
							irfNavigator.go({
								state: "Page.Bundle",
								pageName: "kgfs.loans.individual.screening.Rejected",
								pageId: item.loanId
							}, {
									state: 'Page.Engine',
									pageName: "kgfs.loans.individual.screening.RejectedQueue"
								});
						},
