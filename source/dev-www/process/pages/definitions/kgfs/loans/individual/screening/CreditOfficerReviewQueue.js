define({
	pageUID: "kgfs.loans.individual.screening.CreditOfficerReviewQueue",
   pageType: "Engine",
	   ...
	   return {
		...
		definition: {
			...
			listOptions: {
				...
				getActions: function () {
					return [{
						name: "Credit_Officer_Review",
						desc: "",
						icon: "fa fa-pencil-square-o",
						fn: function (item, index) {
							entityManager.setModel('kgfs.loans.individual.screening.CreditOfficerReview', {
								_request: item
							});
							irfNavigator.go({
								state: "Page.Bundle",
								pageName: "kgfs.loans.individual.screening.CreditOfficerReview",
								pageId: item.loanId
							}, {
									state: 'Page.Engine',
									pageName: "kgfs.loans.individual.screening.CreditOfficerReviewQueue"
								});
						},
