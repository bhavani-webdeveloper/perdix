define({
	pageUID: "kgfs.loans.individual.screening.BusinessTeamReviewQueue",
   pageType: "Engine",
	   ...
	   return {
		...
		definition: {
			...
			listOptions: {
				...
				getActions: function () {
					return [{
						name: "Business_Team_Review",
						desc: "",
						icon: "fa fa-pencil-square-o",
						fn: function (item, index) {
							entityManager.setModel('kgfs.loans.individual.screening.BusinessTeamReview', {
								_request: item
							});
							irfNavigator.go({
								state: "Page.Bundle",
								pageName: "kgfs.loans.individual.screening.BusinessTeamReview",
								pageId: item.loanId
							}, {
									state: 'Page.Engine',
									pageName: "kgfs.loans.individual.screening.BusinessTeamReviewQueue"
								});
						},
