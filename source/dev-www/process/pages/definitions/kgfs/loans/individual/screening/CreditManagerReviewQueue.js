define({
	pageUID: "kgfs.loans.individual.screening.CreditManagerReviewQueue",
   pageType: "Engine",
				...
				getActions: function () {
					return [{
						...
						fn: function (item, index) {
							entityManager.setModel('kgfs.loans.individual.screening.CreditManagerReview', {
								_request: item
							});
							irfNavigator.go({
								state: "Page.Bundle",
								pageName: "kgfs.loans.individual.screening.CreditManagerReview",
								pageId: item.loanId
							}, {
									state: 'Page.Engine',
									pageName: "kgfs.loans.individual.screening.CreditManagerReviewQueue"
								});
						},
