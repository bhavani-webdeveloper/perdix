define({
	pageUID: "kgfs.loans.individual.screening.RiskReviewAndLoanSanctionQueue",
   pageType: "Engine",
				...
				getActions: function () {
					return [{
						...
						fn: function (item, index) {
							entityManager.setModel('kgfs.loans.individual.screening.RiskReviewAndLoanSanction', {
								_request: item
							});
							irfNavigator.go({
								state: "Page.Bundle",
								pageName: "kgfs.loans.individual.screening.RiskReviewAndLoanSanction",
								pageId: item.loanId
							}, {
									state: 'Page.Engine',
									pageName: "kgfs.loans.individual.screening.RiskReviewAndLoanSanctionQueue"
								});
						},
