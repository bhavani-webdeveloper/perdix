define({
    pageUID: "arohan.dashboard.lead.LeadAssignmentPendingQueue",
    pageType: "Engine",
    ...
    $pageFn: function($log, formHelper,PageHelper, Lead, $state, $q, SessionStore, Utils, entityManager) {
		...
		return {
			...
			initialize: function(model, form, formCtrl) {
				model.branch = branch;console.log(" r ::  arohan.dashboard.lead.LeadAssignmentPendingQueue");
					...
					getBulkActions: function() {
						return [{
							...
							fn: function(items) {
								...
								$state.go("Page.Engine", {
									pageName: "arohan.dashboard.lead.LeadReassign",
									pageData: items
								});
							},
