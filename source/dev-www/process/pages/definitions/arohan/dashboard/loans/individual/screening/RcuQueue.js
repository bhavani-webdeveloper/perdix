define({
	pageUID: "arohan.dashboard.loans.individual.screening.RcuQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.Rcu', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arohan.dashboard.loans.individual.screening.Rcu",
									pageId: item.loanId
								});
							},
