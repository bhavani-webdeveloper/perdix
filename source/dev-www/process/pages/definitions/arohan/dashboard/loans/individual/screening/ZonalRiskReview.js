irf.pageCollection.factory(irf.page('arohan.dashboard.loans.individual.screening.ZonalRiskReview'), ["$log", "$q", "$timeout", "SessionStore", "$state", "entityManager", "formHelper", "$stateParams", "Enrollment", "LoanAccount", "LoanProcess", "irfProgressMessage", "PageHelper", "irfStorageService", "$filter",
            ...
            // },
             {
                ...
                //arohan.dashboard.loans.individual.screening.detail.LoanApplicationView
