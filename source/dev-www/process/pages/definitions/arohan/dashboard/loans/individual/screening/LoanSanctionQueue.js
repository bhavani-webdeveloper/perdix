define({
	pageUID: "arohan.dashboard.loans.individual.screening.LoanSanctionQueue", 
	pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.SanctionInput', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "arohan.dashboard.loans.individual.screening.SanctionInput",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
