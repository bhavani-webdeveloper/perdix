define({
	pageUID: "arohan.dashboard.loans.individual.screening.FieldAppraisalQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.FieldAppraisal', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arohan.dashboard.loans.individual.screening.FieldAppraisal",
									pageId: item.loanId
								});
							},
