define({
	pageUID: "arohan.dashboard.loans.individual.screening.AcmRecommendationReviewQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.AcmRecommendationReview', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arohan.dashboard.loans.individual.screening.AcmRecommendationReview",
									pageId: item.loanId
								});
							},
