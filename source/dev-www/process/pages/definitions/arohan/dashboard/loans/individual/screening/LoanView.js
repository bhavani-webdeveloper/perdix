define(["perdix/domain/model/loan/LoanProcess",
    ...
    return {
        pageUID: "arohan.dashboard.loans.individual.screening.LoanView",
        pageType: "Bundle",
            ...
            return {
                ...
                "bundleDefinitionPromise": function() {
                    return $q.resolve([
                        ...
                        {
                            pageName: 'arohan.dashboard.loans.individual.screening.vehiclevaluation.VehicleValuation',
                        ...
                        {
                            pageName: 'arohan.dashboard.loans.individual.screening.CreditBureauView',
                            title: 'CREDIT_BUREAU',
                            pageClass: 'cbview',
                            minimum: 1,
                            maximum: 1,
