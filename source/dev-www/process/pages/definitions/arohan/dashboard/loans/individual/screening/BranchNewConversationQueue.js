irf.pageCollection.factory(irf.page("arohan.dashboard.loans.individual.screening.BranchNewConversationQueue"), 
						...
						return [{
							...
							fn: function(item, index) {
								...
								irfNavigator.go({
									...
									state: 'Page.Engine',
                                    pageName: "arohan.dashboard.loans.individual.screening.BranchNewConversationQueue"
								});
							},
