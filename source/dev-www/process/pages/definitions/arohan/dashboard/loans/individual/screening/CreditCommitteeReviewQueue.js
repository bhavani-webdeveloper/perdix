define({////arohan.dashboard.loans.individual.screening.FieldAppraisal
	pageUID: "arohan.dashboard.loans.individual.screening.CreditCommitteeReviewQueue", 
	pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.CreditCommitteeReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "arohan.dashboard.loans.individual.screening.CreditCommitteeReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
