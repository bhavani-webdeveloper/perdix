irf.pageCollection.factory(irf.page("arohan.dashboard.loans.individual.screening.SpokeRepliedConversationQueue"), 
						...
						return [{
							...
							fn: function(item, index) {
								...
								irfNavigator.go({
									...
									state: 'Page.Engine',
									pageName: "arohan.dashboard.loans.individual.screening.SpokeRepliedConversationQueue"
