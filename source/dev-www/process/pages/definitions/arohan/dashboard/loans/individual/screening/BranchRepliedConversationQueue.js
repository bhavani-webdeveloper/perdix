irf.pageCollection.factory(irf.page("arohan.dashboard.loans.individual.screening.BranchRepliedConversationQueue"), 
	...
	function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, Messaging, LoanBookingCommons, irfNavigator) {
		...
		return {
			...
			initialize: function(model, form, formCtrl) {
				// model.branch = branch;
				console.log("r :: arohan.dashboard.loans.individual.screening.BranchRepliedConversationQueue");
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.LoanView', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									...
									state: 'Page.Engine',
                                    pageName: "arohan.dashboard.loans.individual.screening.BranchRepliedConversationQueue"
								});
							},
