define({////arohan.dashboard.loans.individual.screening.FieldAppraisal
	pageUID: "arohan.dashboard.loans.individual.screening.BhApprovalReviewQueue", 
	pageType: "Engine",
	...
	$pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons, irfNavigator) {
		...
		return {
			"type": "search-list",
			"title": "BH_CREDIT_APPROVAL_QUEUE", 
			"subTitle": "",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.BhApprovalReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "arohan.dashboard.loans.individual.screening.BhApprovalReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
                                    pageName: "arohan.dashboard.loans.individual.screening.BhApprovalReviewQueue"
								});
							},
