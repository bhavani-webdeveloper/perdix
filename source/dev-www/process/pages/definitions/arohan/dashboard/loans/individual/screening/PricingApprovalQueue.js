define({
	pageUID: "arohan.dashboard.loans.individual.screening.PricingApprovalQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.PricingApproval', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arohan.dashboard.loans.individual.screening.PricingApproval",
									pageId: item.loanId
								});
							},
