define({
	pageUID: "arohan.dashboard.loans.individual.screening.PricingQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.Pricing', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arohan.dashboard.loans.individual.screening.Pricing",
									pageId: item.loanId
								});
							},
