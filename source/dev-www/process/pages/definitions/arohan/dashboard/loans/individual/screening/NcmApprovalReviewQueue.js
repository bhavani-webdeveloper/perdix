define({////arohan.dashboard.loans.individual.screening.FieldAppraisal
	pageUID: "arohan.dashboard.loans.individual.screening.NcmApprovalReviewQueue", 
	pageType: "Engine",
		...
		return {
			...
			definition: {
				...
				listOptions: {
					...
					getActions: function() {
						return [{
							name: "NCM_APPROVAL_REVIEW",
							desc: "",
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.NcmApprovalReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "arohan.dashboard.loans.individual.screening.NcmApprovalReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
                                    pageName: "arohan.dashboard.loans.individual.screening.NcmApprovalReviewQueue"
								});
							},
