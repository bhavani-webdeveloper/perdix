irf.pageCollection.factory(irf.page("arohan.dashboard.loans.individual.screening.FieldAppraisalReviewQueue"),
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.FieldAppraisalReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "arohan.dashboard.loans.individual.screening.FieldAppraisalReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
