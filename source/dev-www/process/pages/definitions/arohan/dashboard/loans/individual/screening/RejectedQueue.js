define({
    pageUID: "arohan.dashboard.loans.individual.screening.RejectedQueue",
    pageType: "Engine",
    ...
    $pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons) {
        ...
        return {
            ...
            initialize: function(model, form, formCtrl) {
                model.branch = branch;
                console.log("r :: arohan.dashboard.loans.individual.screening.RejectedQueue")
                        ...
                        return [{
                            ...
                            fn: function(item, index) {
                                ...
                                $state.go("Page.Bundle", {
                                    pageName: "arohan.dashboard.loans.individual.screening.Rejected",
                                    pageId: item.id
                                });
                            },
