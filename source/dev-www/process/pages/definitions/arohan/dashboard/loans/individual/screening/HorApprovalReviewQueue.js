define({////arohan.dashboard.loans.individual.screening.FieldAppraisal
	pageUID: "arohan.dashboard.loans.individual.screening.HorApprovalReviewQueue", 
	pageType: "Engine",
		...
		return {
			...
			definition: {
				...
				listOptions: {
					...
					getActions: function() {
						return [{
							name: "HOR_APPROVAL_REVIEW",
							desc: "",
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.HorApprovalReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "arohan.dashboard.loans.individual.screening.HorApprovalReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
                                    pageName: "arohan.dashboard.loans.individual.screening.HorApprovalReviewQueue"
								});
							},
