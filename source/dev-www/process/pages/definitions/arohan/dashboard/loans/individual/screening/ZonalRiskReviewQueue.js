irf.pageCollection.factory(irf.page("arohan.dashboard.loans.individual.screening.ZonalRiskReviewQueue"),
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arohan.dashboard.loans.individual.screening.ZonalRiskReview', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arohan.dashboard.loans.individual.screening.ZonalRiskReview",
									pageId: item.loanId
								});
							},
