define({
    ...
    $pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons) {
        ...
        return {
            "type": "search-list",
            "title": "KYC__CB_SUBMISSION_QUEUE",
            "subTitle": "",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('irep.loans.individual.origination.ScreeningInput', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "irep.loans.individual.origination.ScreeningInput",
                                    pageId: item.loanId
                                });
                            },
