		...
		return {
					...
					></nvd3>
						...
						"items": [{
							...
							"html": '<table class="table table-responsive">' +
								...
								'<tr><td>{{"FIXTURES" | translate}}</td><td>{{model.assetsAndLiabilities.fixtures | irfCurrency}}</td><td></td><td></td></tr>' +
			...
			eventListeners: {
				"financial-summary": function(bundleModel, model, params) {	
					...
					if(liability && liability.data.length>0) {						
