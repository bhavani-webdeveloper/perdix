define({
	pageUID: "irep.loans.individual.origination.EvaluationReviewQueue", 
	pageType: "Engine",
		...
		return {
			...
			definition: {
				...
				listOptions: {
					...
					getActions: function() {
						return [{
							name: "IREP_EVALUATION_REVIEW",
							desc: "",
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('irep.loans.individual.origination.EvaluationReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "irep.loans.individual.origination.EvaluationReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
                                    pageName: "irep.loans.individual.origination.EvaluationReviewQueue"
								});
							},
