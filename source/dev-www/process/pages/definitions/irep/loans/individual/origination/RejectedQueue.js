define({
	pageUID: "irep.loans.individual.origination.RejectedQueue", 
	pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "irep.loans.individual.origination.LoanViewList",
									pageId: item.loanId
								},
								{
									state: "Page.Engine",
									pageName: "irep.loans.individual.origination.RejectedQueue"
								});
							},
