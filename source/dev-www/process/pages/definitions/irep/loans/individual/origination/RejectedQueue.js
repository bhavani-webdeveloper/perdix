define({
	pageUID: "irep.loans.individual.screening.RejectedQueue", 
	pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "irep.loans.individual.screening.LoanViewList",
									pageId: item.loanId
								},
								{
									state: "Page.Engine",
									pageName: "irep.loans.individual.screening.RejectedQueue"
								});
							},
