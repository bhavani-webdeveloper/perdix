define({
	pageUID: "irep.loans.individual.origination.CreditConfirmationQueue", 
	pageType: "Engine",
		...
		return {
			...
			definition: {
				...
				listOptions: {
					...
					getActions: function() {
						return [{
							name: "CREDIT_CONFIRMATION",
							desc: "",
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('irep.loans.individual.origination.CreditConfirmation', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "irep.loans.individual.origination.CreditConfirmation",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
                                    pageName: "irep.loans.individual.origination.CreditConfirmationQueue"
								});
							},
