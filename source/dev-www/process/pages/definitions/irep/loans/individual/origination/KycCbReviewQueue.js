define({
	 pageUID: "irep.loans.individual.origination.KycCbReviewQueue",
    pageType: "Engine",
    ...
    $pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons) {
		...
		return {
			"type": "search-list",
			"title": "IREP_KYC_CB_REVIEW_QUEUE",
			"subTitle": "",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('irep.loans.individual.origination.KycCbReview', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "irep.loans.individual.origination.KycCbReview",
									pageId: item.loanId
								});
							},
