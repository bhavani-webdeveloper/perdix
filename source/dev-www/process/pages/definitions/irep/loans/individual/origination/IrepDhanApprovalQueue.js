define({
	pageUID: "irep.loans.individual.origination.IrepDhanApprovalQueue", 
	pageType: "Engine",
	...
	$pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons, irfNavigator) {
		...
		return {
			"type": "search-list",
			"title": "IPRE_DHAN_APPROVAL_REVIEW", 
			"subTitle": "",
			...
			definition: {
				...
				listOptions: {
					...
					getActions: function() {
						return [{
							name: "IPRE_DHAN_APPROVAL_REVIEW",
							desc: "",
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('irep.loans.individual.origination.IrepDhanApprovalReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "irep.loans.individual.origination.IrepDhanApprovalReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
                                    pageName: "irep.loans.individual.origination.IrepDhanApprovalQueue"
								});
							},
