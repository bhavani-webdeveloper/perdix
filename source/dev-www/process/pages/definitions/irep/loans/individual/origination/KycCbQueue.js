define({
    pageUID: "irep.loans.individual.origination.KycCbQueue",
    pageType: "Engine",
    ...
    $pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons) {
        ...
        return {
            "type": "search-list",
            "title": "IREP_KYC__CB_SUBMISSION_QUEUE",
            "subTitle": "",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('irep.loans.individual.origination.KycCBInput', {
                                    _request: item
                                });
