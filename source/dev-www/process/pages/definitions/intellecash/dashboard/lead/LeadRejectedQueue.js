define({
    pageUID: "intellecash.dashboard.lead.LeadRejectedQueue",
    pageType: "Engine",
    ...
    $pageFn: function($log, formHelper, Lead, $state, $q, SessionStore, Utils, entityManager) {
		...
		return {
			...
			initialize: function(model, form, formCtrl) {
				console.log("r :: intellecash.dashboard.lead.LeadRejectedQueue");
				model.branch = branch;
						...
						return [{
							...
							fn: function(item, index) {
								...
								$state.go("Page.Engine", {
									pageName: "intellecash.dashboard.lead.LeadGeneration",
									pageId: item.id
								});
							},
