define({
    pageUID: "intellecash.dashboard.lead.ReadyForScreeningQueue",
    pageType: "Engine",
...
*/
		return {
			...
			initialize: function(model, form, formCtrl) {
				console.log("intellecash.dashboard.lead.ReadyForScreeningQueue");
				model.branch = branch;
				...
				listOptions: {
					...
					getActions: function() {
						...
						},
						{
							...
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('intellecash.dashboard.lead.LeadGeneration', {
									_request: item
								});
						...
						},
						{
							...
							icon: "fa fa-pencil-square-o",
							fn: function(item, index) {
								entityManager.setModel('intellecash.dashboard.lead.LeadReject', {
									_request: item
								});
								$state.go("Page.Engine", {
									pageName: "intellecash.dashboard.lead.LeadReject",
									pageId: item.id
								});
							},
							isApplicable: function(item, index) {
