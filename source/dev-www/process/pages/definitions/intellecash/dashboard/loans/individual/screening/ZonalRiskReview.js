irf.pageCollection.factory(irf.page('intellecash.dashboard.loans.individual.screening.ZonalRiskReview'), ["$log", "$q", "$timeout", "SessionStore", "$state", "entityManager", "formHelper", "$stateParams", "Enrollment", "LoanAccount", "LoanProcess", "irfProgressMessage", "PageHelper", "irfStorageService", "$filter",
            ...
            // },
             {
                ...
                //intellecash.dashboard.loans.individual.screening.detail.LoanApplicationView
