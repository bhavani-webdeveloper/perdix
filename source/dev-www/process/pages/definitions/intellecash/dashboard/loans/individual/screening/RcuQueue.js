define({
	pageUID: "intellecash.dashboard.loans.individual.screening.RcuQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('intellecash.dashboard.loans.individual.screening.Rcu', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "intellecash.dashboard.loans.individual.screening.Rcu",
									pageId: item.loanId
								});
							},
