define(["perdix/domain/model/loan/LoanProcess",
    ...
    return {
        pageUID: "intellecash.dashboard.loans.individual.screening.LoanView",
        pageType: "Bundle",
        ...
        $pageFn: function ($log, $q, $timeout, SessionStore, $state, entityManager, formHelper, $stateParams, Enrollment, LoanAccount, Lead, PageHelper, StorageService, $filter, Groups, AccountingUtils, Enrollment, Files, elementsUtils, CustomerBankBranch, Queries, Utils, IndividualLoan, BundleManager, irfNavigator) {
            return {
                ...
                "bundleDefinitionPromise": function() {
                    return $q.resolve([
                        {
                            pageName: 'intellecash.dashboard.loans.individual.customer.IndividualEnrollment2',
                            title: 'APPLICANT',
                            pageClass: 'applicant',
                            minimum: 1,
                            maximum: 1,
                        ...
                        {
                            pageName: 'intellecash.dashboard.loans.individual.customer.EnterpriseEnrolment2',
                            title: 'BUSINESS',
                            pageClass: 'business',
                            minimum: 1,
                            maximum: 1,
                        ...
                        {
                            pageName: 'intellecash.dashboard.loans.individual.screening.VehicleDetails',
                        ...
                        {
                            pageName: 'intellecash.dashboard.loans.individual.screening.vehiclevaluation.VehicleValuation',
                        ...
                        {
                            pageName: 'intellecash.dashboard.loans.individual.screening.CreditBureauView',
                            title: 'CREDIT_BUREAU',
                            pageClass: 'cbview',
                            minimum: 1,
                            maximum: 1,
                        ...
                        {
                            pageName: 'intellecash.dashboard.loans.individual.screening.detail.Scoring',
                            title: 'Cam',
                            pageClass: 'scoring',
                            minimum: 1,
                            maximum: 1,
