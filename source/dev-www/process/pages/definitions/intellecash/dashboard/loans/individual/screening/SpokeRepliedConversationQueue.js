irf.pageCollection.factory(irf.page("intellecash.dashboard.loans.individual.screening.SpokeRepliedConversationQueue"), 
						...
						return [{
							...
							fn: function(item, index) {
								...
								irfNavigator.go({
									...
									state: 'Page.Engine',
									pageName: "intellecash.dashboard.loans.individual.screening.SpokeRepliedConversationQueue"
