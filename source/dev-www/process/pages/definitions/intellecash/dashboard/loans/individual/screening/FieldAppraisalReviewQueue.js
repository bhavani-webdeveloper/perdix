irf.pageCollection.factory(irf.page("intellecash.dashboard.loans.individual.screening.FieldAppraisalReviewQueue"),
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('intellecash.dashboard.loans.individual.screening.FieldAppraisalReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "intellecash.dashboard.loans.individual.screening.FieldAppraisalReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
