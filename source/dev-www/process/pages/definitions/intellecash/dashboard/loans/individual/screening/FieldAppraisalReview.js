irf.pageCollection.factory(irf.page('intellecash.dashboard.loans.individual.screening.FieldAppraisalReview'), ["$log", "$q", "$timeout", "SessionStore", "$state", "entityManager", "formHelper", "$stateParams", "Enrollment", "LoanAccount", "LoanProcess", "irfProgressMessage", "PageHelper", "irfStorageService", "$filter",
    ...
    function($log, $q, $timeout, SessionStore, $state, entityManager, formHelper, $stateParams, Enrollment, LoanAccount, LoanProcess, irfProgressMessage, PageHelper, StorageService, $filter, Groups, AccountingUtils, Enrollment, Files, elementsUtils, CustomerBankBranch, Queries, Utils, IndividualLoan, BundleManager, Message, irfNavigator,Scoring) {
        ...
        var getBundleDefinition = function() {
            var definition = [{
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.IndividualEnrollmentView',
                title: 'APPLICANT',
                pageClass: 'applicant',
                minimum: 1,
                maximum: 1,
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.EnterpriseEnrollmentView',
                title: 'BUSINESS',
                pageClass: 'business',
                minimum: 1,
                maximum: 1,
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.EnterpriseFinancialView',
            ...
            }, 
            {
             ...
             {
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.PortfolioAnalysis',
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.LoanApplicationView',
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.Summary',
                title: 'SUMMARY',
                pageClass: 'summary',
                minimum: 1,
                maximum: 1,
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.Review',
                title: 'REVIEW',
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.SummaryView',
                title: 'SummaryView',
                ...
                pageName: 'intellecash.dashboard.loans.individual.screening.detail.PortfolioAnalyticsView',
