define(["perdix/domain/model/loan/LoanProcess",
    ...
    "perdix/domain/model/loan/LoanCustomerRelation",
        ...
        return {
            pageUID: "intellecash.dashboard.loans.individual.screening.Application",
            pageType: "Bundle",
            ...
            $pageFn: function ($log, $q, $timeout, SessionStore, $state, entityManager, formHelper, $stateParams, Enrollment,IndividualLoan, Lead, irfProgressMessage, PageHelper, StorageService, $filter, Groups, AccountingUtils, Enrollment, Files, elementsUtils, CustomerBankBranch,Queries, Utils, IndividualLoan, BundleManager, Message) {
                return {
                    ...
                    "bundleDefinitionPromise": function() {
                        return $q.resolve([
                            {
                                pageName: 'intellecash.dashboard.loans.individual.customer.IndividualEnrolment2',
                                title: 'APPLICANT',
                                pageClass: 'applicant',
                                minimum: 1,
                                maximum: 0,
                            ...
                            // },
                            // {
                            //     pageName: 'intellecash.dashboard.loans.individual.customer.EnterpriseEnrolmentBusinessFinancial',
                            ...
                            // },
                            {
                                pageName: 'intellecash.dashboard.loans.individual.customer.Enrolment',
                                title: 'BUSINESS',
                                pageClass: 'business',
                                minimum: 1,
                                maximum: 1,
