irf.pageCollection.factory(irf.page("intellecash.dashboard.loans.individual.screening.CentralRiskReviewQueue"), 
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('intellecash.dashboard.loans.individual.screening.CentralRiskReview', {
									_request: item
								});
								irfNavigator.go({
									state: "Page.Bundle",
									pageName: "intellecash.dashboard.loans.individual.screening.CentralRiskReview",
									pageId: item.loanId
								}, {
									state: 'Page.Engine',
