                    ...
                    model.customer = {};
                     if(_.hasIn($stateParams, "pageId") && !_.isNull($stateParams.pageId)) {
                        ...
                        InsuranceProcess.fromInsurancePolicyID($stateParams.pageId)
                         ...
                         Enrollment.getTelecallingByProcessTypeInsurance({id: $stateParams.pageId},function(respo) {
                                model.telecalling = {};                           
                                model.telecalling.telecallingDetail = respo;  
                                ...
                                Queries.questionnaireDetails('TELECALLING', 'Insurance', 'InsuranceTLI').then(
                                    function(res) {                                       
                                       ...
                                       if(model.telecalling.telecallingDetail.telecallingQuestionnaireList.length>0  && model.questionnaireDetails.length>0 ) {
                                        model.questionnaireDetails.forEach(function(data) {
                                            var pos = _.findIndex(model.telecalling.telecallingDetail.telecallingQuestionnaireList, {'question':data.question});
                                            if(pos!= -1) {
                                                _.merge(model.telecalling.telecallingDetail.telecallingQuestionnaireList[pos], data);
                                            }
                                        });
                                    } else {
                                        model.telecalling.telecallingDetail.telecallingQuestionnaireList = model.questionnaireDetails;
                                    }
                                    }, function(error) {
                        ...
                        model.telecalling = {};
                        model.telecalling.telecallingDetail = {};
                        model.telecalling.telecallingDetail.processType = 'INSURANCETLI';
                        model.telecalling.telecallingDetail.telecallingQuestionnaireList = [];
                        model.questionnaireDetails = [];
                        var promises = [];
                        //PageHelper.showLoader();
                        Queries.questionnaireDetails('TELECALLING', 'Insurance', 'InsuranceTLI').then(
                                ...
                                "Telecalling": {
                                    ...
                                    items: {
                                        "questionnaire": {
                                            type: "section",
                                            htmlClass: "row",
                                            html: '<irf-questionnaire telecalling-detail="model.telecalling.telecallingDetail" questionnaire-details="model.questionnaireDetails"></irf-questionnaire>'
                                        }
                                    }
                                },
                                "InsurancePolicyInformation": {
                       ...
                       if(model.insurancePolicyDetailsDTO.id){
                            model.insuranceProcess.update()
                                ...
                                .subscribe(function(value) {
                                        ...
                                        model.telecalling.telecallingDetail.customerId = value.insurancePolicyDetailsDTO.customerId;
                                        model.telecalling.telecallingDetail.processId = value.insurancePolicyDetailsDTO.InsurancePolicyDetails.id;                                       
                                        
                                        Enrollment.createTelecalling(model.telecalling, function(res) {
                                            model.telecalling.telecallingDetail = res.telecallingDetail;
                                ...
                                .subscribe(function(value) {
                                        value.insurancePolicyDetailsDTO = value.insurancePolicyDetailsDTO[0];
                                    
                                        model.telecalling.telecallingDetail.customerId = value.insurancePolicyDetailsDTO.customerId;
                                        model.telecalling.telecallingDetail.processId = value.insurancePolicyDetailsDTO.id;
