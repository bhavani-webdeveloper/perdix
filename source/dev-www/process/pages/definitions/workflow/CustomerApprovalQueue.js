...
irf.pageCollection.factory(irf.page("workflow.CustomerApprovalQueue"),
					...
					return [
                        {
                            ...
                            fn: function(item, model){
								var pageName = item.currentStage == 'InfoUpdateInit' ? 'workflow.CustomerInfoUpdateInit': 'workflow.CustomerApprovalInit';
                                irfNavigator.go({
                                    state: "Page.Engine",
