define([
    ...
    "perdix/domain/model/lead/LeadProcess",
    "perdix/domain/model/lead/LeadProcessFactory"
], function(LoanProcess, LoanFactory, EnrolmentProcess, LoanCustomerRelation, LeadProcess, LeadProcessFactory) {
    LeadProcess = LeadProcess["LeadProcess"];
    LeadProcessFactory = LeadProcessFactory["LeadProcessFactory"];
    return {
        pageUID: "demo.Demo",
        pageType: "Engine",
        ...
        $pageFn: function($log, Enrollment, SessionStore, Files, formHelper, Queries){
            return {
                ...
                initialize: function (model, form, formCtrl) {
                    LeadProcessFactory.createFromLeadId(1)
                        .map(leadProcess => {
                            console.log(1);
                        ...
                        .map(leadProcess => {
                            console.log(2);
                            console.log(leadProcess);
                            leadProcess.lead.currentStage = 'Completed';
                            leadProcess.lead.shahal = 'at';
                            return leadProcess.proceed();
                        })
                        .mergeAll(leadProcess => {
                            console.log(3);
                            console.log(leadProcess);
                            return leadProcess;
                        })
