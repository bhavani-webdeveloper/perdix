                ...
                if ($stateParams.pageId) {
                    ...
                    GroupProcess.getGroup({
                        ...
                        var customerPromises = [],
                            dscPromises = [];
                        model.group.checkerTransactionHistory = [{
                            "accountId":model.group.branchId,
                            "accountNumber":model.group.branchId, 
                            "applicationNumber":model.group.branchId,
                        ...
                        for (i in model.group.jlgGroupMembers) {
                            ...
                            customerPromises.push(Enrollment.get({
