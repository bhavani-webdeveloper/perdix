                        ...
                        function(res) {
                            ...
                            loanresponse.then(
                                function(response) {
                                    ...
                                    var assetvalue = 0;
                                    if ((model.loanMonitoringDetails.currentStage == "LUCSchedule" || model.loanMonitoringDetails.currentStage == "LUCReview") && !(model.loanMonitoringDetails.lucEscalatedReason)) {
                                        $log.info("inside sc");
