irf.pageCollection.factory(irf.page("loans.individual.collections.TransactionAuthorizationQueue"),
    ["$log", "formHelper", "entityManager", "LoanCollection", "$state", "SessionStore", "$q","irfProgressMessage","Locking",
        function ($log, formHelper, entityManager, LoanCollection, $state, SessionStore, $q,irfProgressMessage,Locking) {
            return {
                "type": "search-list",
