irf.pageCollection.factory(irf.page("loans.individual.documentTracking.QualityCheckQueue"), ["$log", "formHelper", "DocumentTracking", "$state", "SessionStore", "Utils", "PageHelper", "entityManager",
