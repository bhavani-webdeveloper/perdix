define({
    pageUID: "loans.individual.disbursement.JLGReadyForDisbursementQueue",
    pageType: "Engine",
    dependencies: ["$log", "formHelper", "$state", "SessionStore", "$q", "IndividualLoan","PageHelper","entityManager"],
    $pageFn: function($log, formHelper,  $state, SessionStore, $q, IndividualLoan,PageHelper,entityManager) {
