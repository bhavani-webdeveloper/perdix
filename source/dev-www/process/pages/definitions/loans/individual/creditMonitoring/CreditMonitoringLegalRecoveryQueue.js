irf.pageCollection.factory(irf.page("loans.individual.creditMonitoring.CreditMonitoringLegalRecoveryQueue"), ["$log", "formHelper", "CreditMonitoring", "$state", "SessionStore", "Utils",
