define({
pageUID: "loans.individual.screening.detail.PortfolioAnalyticsView",
pageType: "Engine",
...
<div class="col-md-6 col-sm-6">
	<table class="table table-condensed table-bordered table-sm table-responsive">
		...
		<tbody>
			<tr class="table-sub-header" style="font-size: 30px;"><th class="text-center" colspan="2">{{model.portfolioAnalytics.emiProfitPercentage.toFixed(2)}}%</th><th><div style="background-color:#18c118">&nbsp;</div></th></tr>
...
<div class="col-md-6 col-sm-6">
	<table class="table table-bordered table-sm table-responsive table-condensed">
		<colgroup><col width="33%"><col width="33%"><col width="33%"></colgroup>
		<tbody>
			<tr class="table-sub-header" style="font-size: 30px;"><th class="text-center" colspan="2">{{model.portfolioAnalytics.emiBankBalancePercentage.toFixed(2)}}%</th><th><div style="background-color:#18c118">&nbsp;</div></th></tr>
