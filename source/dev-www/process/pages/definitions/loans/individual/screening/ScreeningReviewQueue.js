irf.pageCollection.factory(irf.page("loans.individual.screening.ScreeningReviewQueue"),
	["$log", "formHelper", "$state", "$q", "SessionStore", "Utils", "entityManager", "IndividualLoan", "LoanBookingCommons", "irfNavigator", "Locking", "irfProgressMessage",
		function ($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons, irfNavigator, Locking, irfProgressMessage) {
