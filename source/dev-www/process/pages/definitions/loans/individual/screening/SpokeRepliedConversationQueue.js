irf.pageCollection.factory(irf.page("loans.individual.screening.SpokeRepliedConversationQueue"), 
						...
						return [{
							...
							fn: function(item, index) {
								...
								irfNavigator.go({
									...
									state: 'Page.Engine',
                                    pageName: "loans.individual.screening.SpokeRepliedConversationQueue"
								});
							},
