        ...
        "
            ...
            var getThermalReceipt = function(opts,repaymentInfo,indvTransaction){
                var thermalReceiptArray = [
                    ...
                    [1,3,"Website:https://www.dvarakgfs.com/"],
                    ...
                    IndividualLoan.get({
                        ...
                        .then(function (res) {
                            ...
                            if (_.hasIn(model.loanAccount, 'accountNumber') && !_.isNull(model.loanAccount.accountNumber)) {
                                var loanpromise = LoanAccount.get({
                                    ...
                                    .then(
                                        function (res) {
                                            ...
                                            model.cbsLoan.repaymentScheduleTblFormat = {
                                                columns: [],
                                                data: []
                                            };
                                            if (model.cbsLoan.repaymentSchedule.length > 0) {
                                                ...
                                                for (var itr = 0; itr < keys.length; itr++) {
                                                    ...
                                                    switch (keys[itr]) {
                                                        ...
                                                        case 'description':
                                                            title = "TYPE";
                                                            orderNo = 1;
                                                            model.cbsLoan.repaymentScheduleTblFormat.columns.splice(1, 0, {
                                                                "title": title,
                                                                "data": keys[itr],
                                                                "orderNo": orderNo
                                                            });
                                                    ...
                                                    model.cbsLoan.repaymentScheduleTblFormat.columns.push({
                                                        "title": title,
                                                        "data": keys[itr],
                                                        format: format,
                                                        "orderNo": orderNo
                                                ...
                                                model.cbsLoan.repaymentScheduleTblFormat.columns = model.cbsLoan.repaymentScheduleTblFormat.columns.sort(function (a, b) {
                                                    return a.orderNo - b.orderNo
                                                });
                                                model.cbsLoan.repaymentScheduleTblFormat.data = model.cbsLoan.repaymentSchedule;
                                                model.cbsLoan.orgRepaymentScheduleTblFormat = {
                                                    columns: model.cbsLoan.repaymentScheduleTblFormat.columns
                                                };
                                                model.cbsLoan.orgRepaymentScheduleTblFormat.data = $filter('filter')(model.cbsLoan.repaymentSchedule, {
                                                    status: 'true'
                                                });
                                            }
                                            ...
                                            model.cbsLoan.accountStatementTblFormat = {
                                                columns: [],
                                                data: []
                                            };
                                            if (model.cbsLoan.accountStatement.length > 0) {
                                                ...
                                                model.cbsLoan.orgAccountStatementTblFormat = {
                                                    columns: model.cbsLoan.accountStatementTblFormat.columns
                                                };
                                            ...
                                            if (model.cbsLoan.transactions.length > 0) {
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        "onClick": function (data) {
                                                            ...
                                                            if (data.transactionName == 'Demand') {
                                                                ...
                                                                var m = $filter('filter')(model.feesFormMappingList, {
                                                                    fee_category: data.param1,
                                                                    fee_description: data.description,
                                                                    invoice_type: "Fee Charge"
                                                                });
                                                                if (m && m.length == 0) {
                                                                    m = $filter('filter')(model.feesFormMappingList, {
                                                                        fee_category: data.param1,
                                                                        fee_description: "ALL",
                                                                        invoice_type: "Fee Charge"
                                                                    });
                                                ...
                                                model.cbsLoan.orgTransactions.columns = [{
                                                        ...
                                                        "onClick": function (data) {
                                                            PageHelper.showLoader();
                                                            LoanAccount.transactionDetails({
                                                                    'transaction_id': data.transactionId
                                                                })
                                                                .$promise
                                                                .then(function (data) {
                                                                    var modalInstance = irfSimpleModal('Details', transactionDetailHtml, {
                                                                        orgTransactionDetails: data
                                                                    }, {
                                                                        size: "lg"
                                                                    });
                                                                })
                                ...
                                var repaypromise = RepaymentReminder.getAccountDetails({
                                        accountNumber: model.loanAccount.accountNumber
                                    })
                                    .$promise
                                    .then(
                                ...
                                var enrollmentpromise = Enrollment.getCustomerById({
                                        ...
                                        "items": [{
                                                ...
                                                "items": [{
                                                    ...
                                                    "onClick": function (model, form, schemaForm, event) {
                                                        var doc = model.allExistingDocs[event.arrayIndex];
                    ...
                    },*/
                    {
                        ...
                        "items": [{
                                ...
                                "onClick": function (model, form, schemaForm, event) {
                                    ...
                                    LoanAccount.repaymentScheduleDownload({
                                        'account_id': model.cbsLoan.accountId
                                    }).$promise.then(function (res) {
                                        Utils.downloadFile(Misc.formDownload({
                                            'formName': 'installment_schedule_loan',
                                            'recordId': model.cbsLoan.accountId
                                        }));
                                        PageHelper.hideLoader();
                                    }, function (err) {
                                        console.log(err);
                ...
                actions: {
                    ...
                    update: function (model, formCtrl, form, $event) {
                        ...
                        */
                        ...
                        reqData.loanAccount.loanDocuments = [];
                        _.forEach(model.remainingDocsArray, function (obj, i) {
                            if (obj.documentId) {
                                reqData.loanAccount.loanDocuments.push(obj);
                            }
                        });
                        _.forEach(model.allExistingDocs, function (obj, i) {
                            if (obj.documentId) {
                                reqData.loanAccount.loanDocuments.push(obj);
                            }
                        })
                    ...
                    submit: function (model, form, formName) {
                        ...
                        model.reqData.loanAccount.loanDocuments = [];
                        _.forEach(model.remainingDocsArray, function (obj, i) {
                            if (obj.documentId) {
                                model.reqData.loanAccount.loanDocuments.push(obj);
                            }
                        });
                        _.forEach(model.allExistingDocs, function (obj, i) {
                            if (obj.documentId) {
