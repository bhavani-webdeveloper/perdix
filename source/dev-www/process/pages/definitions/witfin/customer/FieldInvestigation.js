...
irf.pageCollection.factory(irf.page("witfin.customer.FieldInvestigation"),
...
function($log, $q, Enrollment,IrfFormRequestProcessor, EnrollmentHelper, PageHelper,formHelper,elementsUtils,
    ...
    var getIncludes = function (model) { 
            return [
                "basicDetails",
                "basicDetails.applicantInformation",
                "basicDetails.applicantInformation.firstName",
                "basicDetails.contactInformation",
                "basicDetails.contactInformation.contracInfo",
                "basicDetails.contactInformation.contracInfo.mobilePhone",
                "basicDetails.contactInformation.contracInfo.landLineNo",
                "basicDetails.contactInformation.residentAddress",
                "basicDetails.contactInformation.residentAddress.doorNo",
                "basicDetails.contactInformation.residentAddress.street",
                "basicDetails.contactInformation.residentAddress.postOffice",
                "basicDetails.contactInformation.residentAddress.landmark",
                "basicDetails.contactInformation.residentAddress.pincode",
                "basicDetails.contactInformation.residentAddress.locality",
                "basicDetails.contactInformation.residentAddress.villageName",
                "basicDetails.contactInformation.residentAddress.district",
                "basicDetails.contactInformation.residentAddress.state",
            ]   
    }
    ...
    return {
        ...
        initialize: function (model, form, formCtrl, bundlePageObj, bundleModel) {
            ...
            this.form = IrfFormRequestProcessor.getFormDefinition('crAppraisal', formRequest);
        },
        offline: false,
