define({
     pageUID: "witfin.loans.individual.screening.DeviationApproval3Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.DeviationApproval3', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "witfin.loans.individual.screening.DeviationApproval3",
                                    pageId: item.loanId
                                });
                            },
