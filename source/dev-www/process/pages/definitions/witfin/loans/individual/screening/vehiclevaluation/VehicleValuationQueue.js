define({
     pageUID: "witfin.loans.individual.screening.vehiclevaluation.VehicleValuationQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.vehiclevaluation. ', {
                                    _request: item
                                });
