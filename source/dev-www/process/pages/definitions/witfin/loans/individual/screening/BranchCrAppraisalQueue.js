define({
    pageUID: "witfin.loans.individual.screening.BranchCrAppraisalQueue",
    pageType: "Engine",
    ...
    $pageFn: function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, IndividualLoan, LoanBookingCommons) {
        ...
        return {
            "type": "search-list",
            "title": "BRANCH_CREDIT_APPRAISAL_QUEUE",
            "subTitle": "",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.BranchCrAppraisal', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "witfin.loans.individual.screening.BranchCrAppraisal",
                                    pageId: item.loanId
                                });
                            },
