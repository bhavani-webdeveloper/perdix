define({
    pageUID: "witfin.loans.individual.screening.FieldInvestigationQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.FieldInvestigation', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "witfin.loans.individual.screening.FieldInvestigation",
                                    pageId: item.loanId
                                });
                            },
