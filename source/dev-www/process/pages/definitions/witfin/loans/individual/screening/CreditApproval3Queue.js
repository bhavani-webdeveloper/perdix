define({
     pageUID: "witfin.loans.individual.screening.CreditApproval3Queue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.CreditApproval3', {
                                    _request: item
                                });
