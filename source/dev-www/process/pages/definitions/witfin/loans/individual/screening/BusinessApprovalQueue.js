define({
     pageUID: "witfin.loans.individual.screening.BusinessApprovalQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.BusinessApproval', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "witfin.loans.individual.screening.BusinessApproval",
                                    pageId: item.loanId
                                });
                            },
