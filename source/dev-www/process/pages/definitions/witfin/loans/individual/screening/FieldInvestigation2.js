define(["perdix/domain/model/loan/LoanProcess",
    ...
    "perdix/domain/model/loan/LoanCustomerRelation",
        ...
        return {
            pageUID: "witfin.loans.individual.screening.FieldInvestigation2",
            pageType: "Bundle",
                ...
                return {
                   ...
                   // "readonly": true,
                    ...
                    "pre_pages_initialize": function(bundleModel){
                        ...
                        bundleModel.currentStage = "FieldInvestigation2";
                        var deferred = $q.defer();
                        ...
                        if (_.hasIn($stateParams, 'pageId') && !_.isNull($stateParams.pageId)){
                            ...
                            .subscribe(function(loanProcess){
                                ...
                                if (loanAccount.loanAccount.currentStage != 'FieldInvestigation2'){
                    ...
                    "post_pages_initialize": function(bundleModel){
                        ...
                        BundleManager.broadcastEvent('origination-stage', 'FieldInvestigation2');
