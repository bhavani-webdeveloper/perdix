irf.pageCollection.factory(irf.page('witfin.loans.individual.screening.ScreeningTest'),
[
    "$log",
    "$q",
    "$timeout",
...
*/
        	return {
        		"type": "page-bundle",
        		"title": "SCREENING_TEST",
        		"subTitle": "LOAN_BOOKING_BUNDLE_SUB_TITLE",
                "bundleDefinitionPromise": function() {
                    return $q.resolve([
                        {
                            pageName: 'witfin.customer.JournalMultiPosting',
                            title: 'APPLICANT',
                            pageClass: 'applicant',
                            minimum: 1,
                            maximum: 1
