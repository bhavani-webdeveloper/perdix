                    ...
                    Utils.confirm("Are You Sure?")
                        .then(
                            function(){
                                ...
                                var result = loan_process.create(reqData)
                                console.log("result")
                                console.log(result)
                                var res = result.subscribe(
                                    function(res) {
                                        console.log("res");
                                        console.log(res)
                                    }, function(err) {
                                ...
                                // var subscription1 = result.subscribe(
                                //      function(x) {
                                //         console.log("res")
                                //         console.log(x);
                                //      },
...
// irf.pageCollection.factory(irf.page("witfin.loans.individual.screening.LoanRequest"),
