define({
    pageUID: "witfin.loans.individual.screening.CreditAppraisalQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('witfin.loans.individual.screening.CreditAppraisal', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "witfin.loans.individual.screening.CreditAppraisal",
                                    pageId: item.loanId
                                });
                            },
