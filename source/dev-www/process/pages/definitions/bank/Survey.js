irf.pageCollection.factory(irf.page("bank.Survey"), ["$log", "Survey", "EnrollmentHelper", "SessionStore", "$state", "formHelper", "$q", "irfProgressMessage",
    "PageHelper", "Utils", "BiometricService",
    function($log, Survey, EnrollmentHelper, SessionStore, $state, formHelper, $q, irfProgressMessage,
        PageHelper, Utils, BiometricService) {
        ...
        return {
            ...
            schema: function() {
                return surverJson.getSchema().$promise;
            },
            actions: {
