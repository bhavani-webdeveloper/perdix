irf.pageCollection.factory(irf.page("base.dashboard.loans.individual.screening.BranchRepliedConversationQueue"), 
	...
	function($log, formHelper, $state, $q, SessionStore, Utils, entityManager, Messaging, LoanBookingCommons, irfNavigator) {
		...
		return {
			...
			initialize: function(model, form, formCtrl) {
				// model.branch = branch;
				console.log("r :: base.dashboard.loans.individual.screening.BranchRepliedConversationQueue");
						...
						return [{
							...
							fn: function(item, index) {
								...
								irfNavigator.go({
									...
									state: 'Page.Engine',
                                    pageName: "base.dashboard.loans.individual.screening.BranchRepliedConversationQueue"
								});
							},
