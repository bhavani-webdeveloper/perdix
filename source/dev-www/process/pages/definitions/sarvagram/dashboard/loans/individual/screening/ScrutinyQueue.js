define({
	pageUID: "sarvagram.dashboard.loans.individual.screening.ScrutinyQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('sarvagram.dashboard.loans.individual.screening.Scrutiny', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "sarvagram.dashboard.loans.individual.screening.Scrutiny",
									pageId: item.loanId
								});
							},
