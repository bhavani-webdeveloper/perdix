define(["perdix/domain/model/loan/LoanProcess",
    ...
    return {
        pageUID: "sarvagram.dashboard.loans.individual.screening.LoanView",
        pageType: "Bundle",
            ...
            return {
                ...
                "bundleDefinitionPromise": function() {
                    return $q.resolve([
                        ...
                        {
                            pageName: 'sarvagram.dashboard.loans.individual.screening.vehiclevaluation.VehicleValuation',
                        ...
                        {
                            pageName: 'sarvagram.dashboard.loans.individual.screening.CreditBureauView',
                            title: 'CREDIT_BUREAU',
                            pageClass: 'cbview',
                            minimum: 1,
                            maximum: 1,
