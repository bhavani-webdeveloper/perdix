define([],function(){
	...
	return {
        pageUID: "request.RescheduleQueue",
        pageType: "Engine",
        ...
        $pageFn: function($log, formHelper, Worklist, $state, SessionStore, Utils, Enrollment) {
			...
			return {
				"type": "search-list",
				"title": "RESCHEDULE_REQUEST_QUEUE",
				"subTitle": "",
				initialize: function(model, form, formCtrl) {
					$log.info("Reschedule Queue got initialized");
					model.branchId = SessionStore.getCurrentBranch().branchId;
				},

				definition: {
					title: "Search Reschedule Requests",
					searchForm: [
						"*"
					],
					autoSearch: true,
					...
					listOptions: {
						...
						getActions: function() {
							return [{
								name: "Capture Reschedule Request Data",
								desc: "",
