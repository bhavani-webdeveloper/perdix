irf.pageCollection.controller(irf.controller("arthan.loans.LoanOriginationDashboard"), ['$log', '$scope', "formHelper", "$state", "$q", "Utils", 'PagesDefinition', 'SessionStore', "entityManager", "IndividualLoan", "LoanBookingCommons", "Lead", "Messaging",
function($log, $scope, formHelper, $state, $q, Utils, PagesDefinition, SessionStore, entityManager, IndividualLoan, LoanBookingCommons, Lead, Messaging) {
    ...
    var currentBranch = SessionStore.getCurrentBranch();
        ...
        "items": [
            "Page/Bundle/arthan.loans.individual.screening.ScreeningInput",
           // "Page/Engine/arthan.lead.ReadyForScreeningQueue",
            "Page/Engine/arthan.loans.individual.screening.ScreeningQueue",
            "Page/Engine/arthan.loans.individual.screening.ScreeningReviewQueue",
            "Page/Engine/arthan.loans.individual.screening.ApplicationQueue",  
            "Page/Engine/arthan.loans.individual.screening.ApplicationReviewQueue", 
            "Page/Engine/arthan.loans.individual.screening.ScrutinyQueue",  
            ...
            "Page/Engine/arthan.loans.individual.screening.BranchNewConversationQueue",
            "Page/Engine/arthan.loans.individual.screening.BranchRepliedConversationQueue",
            "Page/Engine/arthan.loans.individual.screening.SpokeNewConversationQueue", // sql done
            "Page/Engine/arthan.loans.individual.screening.SpokeRepliedConversationQueue",
           ]
    };
    ...
    PagesDefinition.getUserAllowedDefinition(fullDefinition).then(function(resp) {
        ...
        var crrqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.CentralRiskReviewQueue"];
        if (crrqMenu) {
        ...
        var zrrqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.ZonalRiskReviewQueue"];
        if (zrrqMenu) {
            IndividualLoan.search({
        ...
        var ccrqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.CreditCommitteeReviewQueue"];
        if (ccrqMenu) {
            IndividualLoan.search({
        ...
        var lsqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.LoanSanctionQueue"];
        if (lsqMenu) {
            IndividualLoan.search({
                'stage':  'Sanction',
                'enterprisePincode': '',
       ...
       var rfqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.lead.ReadyForScreeningQueue"];
       ...
       if (rfqMenu) rfqMenu.data = 0;
        ...
        var sqMenu=$scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.ScreeningQueue"];
        if (sqMenu) {
            sqMenu.data = 0;
            _.forEach(centres, function(centre) {
                IndividualLoan.search({
       ...
       var srqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.ScreeningReviewQueue"];
...
var aqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.ApplicationQueue"];
...
//
// var farMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.FieldAppraisalReview"];
// if (farMenu) {
//     IndividualLoan.search({
...
//
        var arqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/arthan.loans.individual.screening.ApplicationReviewQueue"];
        if (arqMenu) {
            IndividualLoan.search({
