define({
    pageUID: "arthan.dashboard.loans.individual.screening.ScreeningQueue",
    pageType: "Engine",
                    ...
                    getActions: function() {
                        return [{
                            ...
                            fn: function(item, index) {
                                entityManager.setModel('arthan.dashboard.loans.individual.screening.ScreeningInput', {
                                    _request: item
                                });
                                $state.go("Page.Bundle", {
                                    pageName: "arthan.dashboard.loans.individual.screening.ScreeningInput",
                                    pageId: item.loanId
                                });
                            },
