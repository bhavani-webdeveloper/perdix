define({
	pageUID: "arthan.loans.individual.screening.RcuQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arthan.loans.individual.screening.Rcu', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arthan.loans.individual.screening.Rcu",
									pageId: item.loanId
								});
							},
