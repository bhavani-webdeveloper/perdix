define({
	pageUID: "arthan.dashboard.loans.individual.screening.ApplicationQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arthan.dashboard.loans.individual.screening.Application', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arthan.dashboard.loans.individual.screening.Application",
									pageId: item.loanId
								});
							},
