define({
	pageUID: "arthan.loans.individual.screening.ApplicationQueue",
    pageType: "Engine",
					...
					getActions: function() {
						return [{
							...
							fn: function(item, index) {
								entityManager.setModel('arthan.loans.individual.screening.Application', {
									_request: item
								});
								$state.go("Page.Bundle", {
									pageName: "arthan.loans.individual.screening.Application",
									pageId: item.loanId
								});
							},
