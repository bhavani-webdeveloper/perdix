irf.pages.controller("WitfinLoanOriginationDashboardCtrl", ['$log', '$scope', "formHelper", "$state", "$q", "Utils", 'PagesDefinition', 'SessionStore', "entityManager", "IndividualLoan", "LoanBookingCommons",
    function($log, $scope, formHelper, $state, $q, Utils, PagesDefinition, SessionStore, entityManager, IndividualLoan, LoanBookingCommons) {
        ...
        var fullDefinition = {
            ...
            "items": [
                ...
                "Page/Engine/witfin.loans.individual.screening.FieldAppraisalQueue",
...
*/
            ...
            var faqMenu = $scope.dashboardDefinition.$menuMap["Page/Engine/witfin.loans.individual.screening.FieldAppraisalQueue"];
            if (faqMenu) {
                IndividualLoan.search({
