...
irf.pages.factory("PsychometricTestService", ["$q", "$state", "$rootScope", function($q, $state, $rootScope){
	return {
		...
		close: function () {
			irf.PsychometricTestServiceDeferred = null;
		}
	};
}]);
